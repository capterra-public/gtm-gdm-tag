...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "G2DM - Universal Script",
  "categories": [
    "CONVERSIONS"
  ],
  "brand": {
  ...
  "description": "G2 Digital Markets Universal Script offers added visibility into buyer behavior and campaigns so you can optimize your PPC campaigns maximizing ROAS in an increasingly privacy-first world.",
  "containerContexts": [
    "WEB"
  ]
}
